...
// Prodavec: moved to up because of functions below
waitUntil {!isNil "BIS_fnc_init"};

//--- Modules Override.
BIS_MARTA_mainScope = WF_Logic;
BIS_HC_mainscope = WF_Logic;

Private ['_count'];

// --- those rockets handlers
HandleMissiles = Compile preprocessFileLineNumbers "Common\Functions\Common_HandleMissiles.sqf";
...
//ExecVM "new2.sqf";
//["INITIALIZATION", "new2.sqf: Config Files are loaded."] Call WFBE_CO_FNC_LogContent;
