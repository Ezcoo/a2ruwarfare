...
missionNamespace setVariable [Format["WFBE_%1REPAIRTRUCKS", _side], ['MtvrRepair','MtvrRepair_DES_EP1','KamazRepair','UralRepair_TK_EP1']];
...
missionNamespace setVariable [Format["WFBE_%1STARTINGVEHICLES", _side], ['HMMWV_Ambulance_DES_EP1','LAV25','HMMWV_M998A2_SOV_DES_EP1','HMMWV_M998A2_SOV_DES_EP1','BAF_Jackal2_L2A1_D','BAF_Jackal2_L2A1_D']];//--- Starting Vehicles.
...
if (isServer) then {
	...
	missionNamespace setVariable [Format["WFBE_%1_AI_Loadout_3", _side], [
		...
		[['SCAR_H_STD_EGLM_Spect','Javelin','Colt1911','Binocular','NVGoggles','ItemRadio','ItemMap'],
		 ['20Rnd_762x51_SB_SCAR','20Rnd_762x51_SB_SCAR','20Rnd_762x51_SB_SCAR','20Rnd_762x51_SB_SCAR','20Rnd_762x51_SB_SCAR','20Rnd_762x51_SB_SCAR','7Rnd_45ACP_1911','7Rnd_45ACP_1911','7Rnd_45ACP_1911','7Rnd_45ACP_1911','1Rnd_HE_M203','1Rnd_HE_M203','1Rnd_HE_M203','1Rnd_HE_M203'],
	...
	missionNamespace setVariable [Format["REINFORCER_%1_GROUND_UNITS", _side], [
		[["USMC_SoldierS_Sniper","US_Soldier_TL_EP1","BAF_Soldier_AA_MTP","US_Soldier_AR_EP1","US_Soldier_MG_EP1","US_Soldier_LAT_EP1","US_Soldier_EP1","US_Soldier_HAT_EP1","US_Soldier_Medic_EP1","US_Soldier_GL_EP1"], 0, 2],
		[["USMC_SoldierS_Sniper","US_Soldier_AR_EP1","BAF_Soldier_AA_MTP","US_Soldier_AT_EP1","US_Soldier_AT_EP1","US_Soldier_HAT_EP1","US_Soldier_Medic_EP1","US_Soldier_GL_EP1"], 50, 2],
		[["USMC_SoldierS_Sniper","US_Soldier_AR_EP1","BAF_Soldier_AA_MTP","US_Soldier_AT_EP1","US_Soldier_AT_EP1","US_Soldier_HAT_EP1","US_Soldier_HAT_EP1"], 70, 2],
		[["US_Delta_Force_TL_EP1","BAF_Soldier_AA_MTP","US_Delta_Force_MG_EP1","US_Delta_Force_AR_EP1","US_Delta_Force_AR_EP1","US_Delta_Force_EP1","US_Delta_Force_EP1","US_Soldier_HAT_EP1"], 50, 1],
		[["USMC_SoldierS_Sniper","BAF_Soldier_AA_MTP","US_Delta_Force_MG_EP1","US_Delta_Force_AR_EP1","US_Soldier_HAT_EP1","US_Delta_Force_Medic_EP1","US_Delta_Force_M14_EP1","US_Delta_Force_Air_Controller_EP1"], 50, 2],
		[["US_Soldier_Sniper_EP1","US_Soldier_Sniper_EP1","US_Soldier_Sniper_EP1","US_Soldier_Marksman_EP1","US_Soldier_SniperH_EP1","US_Soldier_Sniper_NV_EP1"], 30, 1],
		[["HMMWV_M998_crows_M2_DES_EP1","HMMWV_M998_crows_MK19_DES_EP1","HMMWV_TOW_DES_EP1"], 30, 2],
		[["HMMWV_M1151_M2_DES_EP1","HMMWV_M1151_M2_DES_EP1","HMMWV_MK19_DES_EP1"], 20, 2],
		[["HMMWV_Avenger_DES_EP1","HMMWV_Avenger_DES_EP1"], 50, 1],
		[["US_Soldier_SL_EP1","M1126_ICV_M2_EP1","US_Soldier_MG_EP1","US_Soldier_AR_EP1","US_Soldier_AT_EP1","US_Soldier_LAT_EP1"], 40, 2],
		[["M1126_ICV_M2_EP1","M1126_ICV_M2_EP1"], 30, 1],
		[["M1126_ICV_M2_EP1","M1126_ICV_mk19_EP1"], 40, 1],
		[["M1126_ICV_M2_EP1","M1126_ICV_mk19_EP1","M1135_ATGMV_EP1"], 50, 1],
		[["M1A1_US_DES_EP1","M1128_MGS_EP1","M1135_ATGMV_EP1"], 60, 1],
		[["US_Soldier_SL_EP1","M2A3_EP1","US_Soldier_AR_EP1","US_Soldier_LAT_EP1","US_Soldier_Medic_EP1","US_Soldier_EP1"], 45, 2],
		[["M2A3_EP1","M2A3_EP1","M6_EP1"], 50, 1],
		[["M1A1_US_DES_EP1","M1A1_US_DES_EP1"], 50, 1],
		[["M1A1_US_DES_EP1","M1A1_US_DES_EP1","M2A3_EP1","M6_EP1"], 50, 1],
		[["M6_EP1","M2A3_EP1","M2A3_EP1"], 80, 2],
		[["M1A2_US_TUSK_MG_EP1","M1A2_US_TUSK_MG_EP1"], 80, 2],
		[["M1A2_US_TUSK_MG_EP1","M1A2_US_TUSK_MG_EP1","M1A1_US_DES_EP1","M6_EP1"], 100, 3]
	]];
	...
	missionNamespace setVariable [Format["REINFORCER_%1_GROUND_UNITS_CONVOY", _side], [
		[[
			[["HMMWV_M1151_M2_DES_EP1"], "HMMWV_DES_EP1", ["HMMWV_M998_crows_M2_DES_EP1"]],
			[
				["US_Soldier_SL_EP1","US_Soldier_TL_EP1","US_Soldier_AR_EP1","US_Soldier_AR_EP1","US_Soldier_MG_EP1","US_Soldier_LAT_EP1","US_Soldier_EP1","US_Soldier_EP1","US_Soldier_Medic_EP1","US_Soldier_GL_EP1"],
				["US_Soldier_SL_EP1","US_Soldier_AR_EP1","US_Soldier_AT_EP1","US_Soldier_AT_EP1","US_Soldier_AT_EP1","US_Soldier_LAT_EP1","US_Soldier_Medic_EP1"]
			]
		], 0, 2],
		[[
			[["HMMWV_M998_crows_M2_DES_EP1"], "HMMWV_DES_EP1", ["HMMWV_M998_crows_MK19_DES_EP1"]],
			[
				["US_Soldier_SL_EP1","US_Soldier_TL_EP1","US_Soldier_AR_EP1","US_Soldier_AR_EP1","US_Soldier_MG_EP1","US_Soldier_LAT_EP1","US_Soldier_EP1","US_Soldier_EP1","US_Soldier_Medic_EP1","US_Soldier_GL_EP1"],
				["US_Delta_Force_TL_EP1","US_Delta_Force_Assault_EP1","US_Delta_Force_MG_EP1","US_Delta_Force_AR_EP1","US_Delta_Force_AR_EP1","US_Delta_Force_EP1","US_Delta_Force_EP1","US_Delta_Force_Medic_EP1"],
				["US_Soldier_SL_EP1","US_Soldier_AR_EP1","US_Soldier_AT_EP1","US_Soldier_AT_EP1","US_Soldier_AT_EP1","US_Soldier_LAT_EP1","US_Soldier_Medic_EP1"]
			]
		], 40, 2],
		[[
			[["M1126_ICV_M2_EP1"], "HMMWV_DES_EP1", ["M1126_ICV_mk19_EP1"]],
			[
				["US_Soldier_SL_EP1","US_Soldier_AR_EP1","US_Soldier_AT_EP1","US_Soldier_AT_EP1","US_Soldier_AT_EP1","US_Soldier_LAT_EP1","US_Soldier_Medic_EP1","US_Soldier_GL_EP1"],
				["US_Soldier_SL_EP1","US_Soldier_Sniper_EP1","US_Soldier_MG_EP1","US_Soldier_AR_EP1","US_Soldier_AR_EP1","US_Soldier_AA_EP1","US_Soldier_AA_EP1","US_Soldier_AA_EP1"],
				["US_Soldier_TL_EP1","US_Soldier_AR_EP1","US_Soldier_HAT_EP1","US_Soldier_HAT_EP1","US_Soldier_AT_EP1","US_Soldier_AT_EP1"]
			]
		], 60, 2],
		[[
			[["M1A1_US_DES_EP1"], "M2A3_EP1", ["HMMWV_Avenger_DES_EP1"]],
			[
				["US_Soldier_SL_EP1","US_Soldier_AR_EP1","US_Soldier_AT_EP1","US_Soldier_AT_EP1","US_Soldier_AT_EP1","US_Soldier_LAT_EP1","US_Soldier_Medic_EP1","US_Soldier_GL_EP1"],
				["US_Soldier_Sniper_EP1","US_Soldier_Sniper_EP1","US_Soldier_Sniper_EP1","US_Soldier_Marksman_EP1","US_Soldier_SniperH_EP1","US_Soldier_Sniper_NV_EP1"]
			]
		], 80, 1],
		[[
			[["M1A2_US_TUSK_MG_EP1"], "M2A3_EP1", ["M6_EP1","M1135_ATGMV_EP1"]],
			[
				["US_Soldier_SL_EP1","US_Soldier_AR_EP1","US_Soldier_AT_EP1","US_Soldier_AT_EP1","US_Soldier_AT_EP1","US_Soldier_LAT_EP1","US_Soldier_Medic_EP1","US_Soldier_GL_EP1"],
				["US_Delta_Force_TL_EP1","US_Delta_Force_Assault_EP1","US_Delta_Force_MG_EP1","US_Delta_Force_AR_EP1","US_Delta_Force_EP1","US_Delta_Force_Medic_EP1","US_Delta_Force_M14_EP1","US_Delta_Force_Air_Controller_EP1"],
				["US_Soldier_Sniper_EP1","US_Soldier_Sniper_EP1","US_Soldier_Sniper_EP1","US_Soldier_Marksman_EP1","US_Soldier_SniperH_EP1","US_Soldier_Sniper_NV_EP1"]
			]
		], 100, 1]
	]];
	...
	if (WF_A2_CombinedOps) then {
		...
		missionNamespace setVariable [Format["REINFORCER_%1_NAVAL_UNITS", _side], [
			[["RHIB",["US_Soldier_SL_EP1","US_Soldier_TL_EP1","US_Soldier_AR_EP1","US_Soldier_AR_EP1","US_Soldier_MG_EP1","US_Soldier_LAT_EP1","US_Soldier_EP1","US_Soldier_EP1","US_Soldier_Medic_EP1"]], 0, 2],
			[["RHIB2Turret",["US_Delta_Force_TL_EP1","US_Delta_Force_Assault_EP1","US_Delta_Force_MG_EP1","US_Delta_Force_AR_EP1","US_Delta_Force_EP1","US_Delta_Force_Medic_EP1","US_Delta_Force_M14_EP1","US_Delta_Force_Air_Controller_EP1"]], 50, 1],
			[["RHIB2Turret",["US_Soldier_SL_EP1","US_Soldier_AR_EP1","US_Soldier_AT_EP1","US_Soldier_AT_EP1","US_Soldier_AT_EP1","US_Soldier_LAT_EP1","US_Soldier_Medic_EP1","US_Soldier_GL_EP1"]], 40, 1]
		]];
	};
	...
	missionNamespace setVariable [Format["REINFORCER_%1_AIR_UNITS", _side], [
		[["UH60M_EP1",["US_Soldier_SL_EP1","US_Soldier_TL_EP1","US_Soldier_AR_EP1","US_Soldier_AR_EP1","US_Soldier_MG_EP1","US_Soldier_LAT_EP1","US_Soldier_EP1","US_Soldier_EP1","US_Soldier_Medic_EP1","US_Soldier_GL_EP1"]], 0, 2],
		[[["MH6J_EP1","CH_47F_EP1"],["US_Delta_Force_TL_EP1","US_Delta_Force_Assault_EP1","US_Delta_Force_MG_EP1","US_Delta_Force_AR_EP1","US_Delta_Force_AR_EP1","US_Delta_Force_EP1","US_Delta_Force_EP1","US_Delta_Force_Medic_EP1"]], 50, 1],
		[["CH_47F_EP1",["US_Soldier_SL_EP1","US_Soldier_AR_EP1","US_Soldier_AT_EP1","US_Soldier_AT_EP1","US_Soldier_AT_EP1","US_Soldier_LAT_EP1","US_Soldier_Medic_EP1"]], 60, 1],
		[["CH_47F_EP1",["US_Soldier_SL_EP1","US_Soldier_AR_EP1","US_Soldier_AT_EP1","US_Soldier_AT_EP1","US_Soldier_AT_EP1","US_Soldier_LAT_EP1","US_Soldier_Medic_EP1","US_Soldier_AT_EP1","US_Soldier_AT_EP1","US_Soldier_LAT_EP1","US_Soldier_Medic_EP1","US_Soldier_GL_EP1"]], 80, 1]
	]];
};
...
missionNamespace setVariable [Format["WFBE_%1_DefaultGear", _side], [
	['SCAR_L_CQC','M136','M9','Binocular','NVGoggles','ItemCompass','ItemMap','ItemRadio','ItemWatch','Moscow_Bombing_File'],
