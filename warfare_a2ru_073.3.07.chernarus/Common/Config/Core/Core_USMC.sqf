...
_i = _i + [['','',930,6,-1,3,0,0.88,'USMC',[]]];

_c = _c + ['USMC_Soldier_AA'];
_i = _i + [['','',450,6,-1,2,0,0.87,'USMC',[]]];
...
_c = _c + ['HMMWV_TOW'];
_i = _i + [['','',2450,20,-2,2,1,0,'USMC',[]]];

_c = _c + ['HMMWV_Avenger'];
_i = _i + [['','',1750,25,-2,3,1,0,'USMC',[]]];

_c = _c + ['HMMWV_Ambulance'];
_i = _i + [['','',3950,22,-2,2,1,0,'USMC',[]]];
...
_c = _c + ['LAV25'];
_i = _i + [['','',1650,27,-2,2,1,0,'USMC',[]]];

/* Heavy Vehicles */
_c = _c + ['AAV'];
_i = _i + [['','',1550,25,-2,0,2,0,'USMC',[]]];

_c = _c + ['M1A1'];
_i = _i + [['','',8650,40,-2,if (WF_A2_Vanilla) then {1} else {2},2,0,'USMC',[]]];

_c = _c + ['MLRS'];
_i = _i + [['','',7800,40,-2,3,2,0,'USMC',[]]];

_c = _c + ['M1A2_TUSK_MG'];
_i = _i + [['','',9950,40,-2,if (WF_A2_Vanilla) then {2} else {3},2,0,'USMC',[]]];

/* Air Vehicles */
_c = _c + ['MH60S'];
_i = _i + [['','',9000,35,-2,0,3,0,'USMC',[]]];

_c = _c + ['UH1Y'];
_i = _i + [['','',15950,40,-2,1,3,0,'USMC',[]]];

_c = _c + ['MV22'];
_i = _i + [['','',13000,43,-2,1,3,0,'USMC',[]]];

_c = _c + ['C130J'];
_i = _i + [['','',15500,52,-2,2,3,0,'USMC',[]]];

_c = _c + ['AH1Z'];
_i = _i + [['','',32950,60,-2,2,3,0,'USMC',[]]];

_c = _c + ['AH64D'];
_i = _i + [['','',35950,60,-2,3,3,0,'USMC',[]]];

_c = _c + ['F35B'];
_i = _i + [['','',48500,62,-2,3,3,0,'USMC',[]]];

_c = _c + ['AV8B'];
_i = _i + [['','',45950,65,-2,3,3,0,'USMC',[]]];

_c = _c + ['AV8B2'];
_i = _i + [['','',45950,65,-2,3,3,0,'USMC',[]]];

_c = _c + ['A10'];
_i = _i + [['','',44500,70,-2,3,3,0,'USMC',[]]];

/* Special */
//_c = _c + ['MQ9PredatorB'];
//_i = _i + [['','',7750,35,2,2,3,0,'USMC',[]]];
...
_c = _c + ['M119'];
_i = _i + [['','',3800,0,1,0,'Defense',0,'USMC',[]]];
