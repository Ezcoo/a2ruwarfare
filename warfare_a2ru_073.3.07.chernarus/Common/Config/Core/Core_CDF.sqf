...
_c = _c + ['GRAD_CDF'];
_i = _i + [['','',6500,35,-2,3,1,0,'CDF',[]]];

/* Heavy Vehicles */
_c = _c + ['BMP2_Ambul_CDF'];
_i = _i + [['','',5500,20,-2,0,2,0,'CDF',[]]];

_c = _c + ['BMP2_CDF'];
_i = _i + [['','',4600,30,-2,1,2,0,'CDF',[]]];

_c = _c + ['ZSU_CDF'];
_i = _i + [['','',5400,35,-2,2,2,0,'CDF',[]]];

_c = _c + ['T72_CDF'];
_i = _i + [['','',6900,35,-2,3,2,0,'CDF',[]]];
...
_i = _i + [['','',6500,35,-2,1,3,0,'CDF',[]]];

_c = _c + ['Mi24_D'];
_i = _i + [['','',29000,40,-2,2,3,0,'CDF',[]]];

_c = _c + ['Su25_CDF'];
_i = _i + [['','',46000,55,-2,3,3,0,'CDF',[]]];
