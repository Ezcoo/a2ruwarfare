System_DisposableRPGTypes=["M136","RPG18","BAF_NLAW_Launcher", "M47Launcher_EP1","MetisLauncher","Javelin"];
...
System_HaveAARadarVehicleTypes=[["2S6M_Tunguska",["2A38M"],2500],["ZSU_INS",["AZP85"],2500],["ZSU_TK_EP1",["AZP85"],2500]];
...
System_TrackedVehicleTypes=["Tank","Tracked_APC","Truck"];

System_MedicalBackPacks=[];
System_MedicalDisposalPacks=["Moscow_Bombing_File"];