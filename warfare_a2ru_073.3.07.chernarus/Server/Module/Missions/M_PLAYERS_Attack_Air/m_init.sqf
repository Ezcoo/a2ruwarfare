...
*/
Private ["_boundaries","_chopper","_group","_jipHandler","_list","_pilot","_players","_ran","_ranDir","_runFor","_ranPos","_target","_turrets","_uniqueIndex","_uniqueLabel","_vehicle"];
...
_list = (_runFor call WFBE_CO_FNC_GetSideLogic) getVariable "wfbe_teams";
...
while {true} do {
    ...
    // Prodavec: old shit, we already got _target using WFBE_CO_FNC_GetClosestEntity
    /*
	{
