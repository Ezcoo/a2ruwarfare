...
// Distance from destination for searching vehicles. 
// If your destination point is further than KRON_UPS_searchVehicledist, AI will try to find and use vehicle.
...
//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------			
	...
	UPSMON_Version = "UPSMON 5.0.8-R3";
	KILLED_CIV_COUNTER = [0,0,0,0];
