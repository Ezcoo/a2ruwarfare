...
//*****************************************************************************************
Private ["_construct","_constructed","_direction","_group","_index","_logik","_nearLogic","_objects","_position","_rlType","_side","_sideID","_site","_siteName","_startTime","_structures","_structuresNames","_time","_timeNextUpdate","_type", "_template"];
...
{
    _template = missionNamespace getVariable format ["WFBE_NEURODEF_%1_WALLS", _rlType];
    
    if (!isNil "_template") then
    {
        _defenses = [_site, _template] call CreateDefenseTemplate;
