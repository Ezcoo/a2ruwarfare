...
if (!_skip) then {
	...
	_tent addAction ["<t color='#f8d664'>" + localize 'STR_WF_ACTION_UndeployMASH'+ "</t>", "Client\Module\Skill\Actions\Officer_Undeploy_MASH.sqf", [], -101, false, true, "", "alive _target && time - WFBE_SK_V_LastUse_MASH > 240"];
} else {
