...
WFBE_SK_V_Engineers = ['BAF_Soldier_EN_DDPM','BAF_Soldier_EN_W','USMC_SoldierS_Engineer','MVD_Soldier_TL','US_Soldier_Engineer_EP1','TK_Soldier_Engineer_EP1','CDF_Soldier_Engineer','Ins_Soldier_Sapper','Soldier_Engineer_PMC','GUE_Soldier_Sab'];
...
WFBE_SK_V_Saboteur = ['FR_Sapper','RUS_Soldier3','US_Delta_Force_Assault_EP1','TK_Soldier_Spotter_EP1'];
