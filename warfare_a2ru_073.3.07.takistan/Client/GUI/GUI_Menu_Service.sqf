...
while {true} do {
	...
	if (_curSel != -1) then {
		...
		if (_veh isKindOf "Man") then {
			...
			_get = missionNamespace getVariable _type;    
			private ['_art'];
			_art = ["GRAD_TK_EP1","M1129_MC_EP1","MLRS_DES_EP1","MLRS","GRAD_CDF","GRAD_INS","GRAD_RU","2b14_82mm","2b14_82mm_CDF",
			"2b14_82mm_GUE","2b14_82mm_INS","D30_CDF","D30_Ins","D30_RU","M119","M252","2b14_82mm_TK_EP1","2b14_82mm_TK_GUE_EP1",
			"2b14_82mm_TK_INS_EP1","D30_TK_EP1","D30_TK_GUE_EP1","D30_TK_INS_EP1","M119_US_EP1","M252_US_EP1"];
			if !(isNil '_get') then 
					{ 
					if ((typeOf _veh) in _art) then 
					{
					_rearmPrice = round(0.8*(_get select QUERYUNITPRICE));
					}  else
					{      
