...
_i = _i + [['','',600,5,-1,2,0,0.9,'US',[]]];

_c = _c + ['US_Soldier_HAT_EP1'];
_i = _i + [['','',930,6,-1,3,0,0.92,'US',[]]];

_c = _c + ['US_Soldier_AA_EP1'];
_i = _i + [['','',450,6,-1,2,0,0.91,'US',[]]];
...
_i = _i + [['','',350,15,-2,0,1,0,'US',[]]];

_c = _c + ['HMMWV_MK19_DES_EP1'];
_i = _i + [['','',900,18,-2,1,1,0,'US',[]]];

_c = _c + ['HMMWV_M998A2_SOV_DES_EP1'];
_i = _i + [['','',1050,20,-2,1,1,0,'US',[]]];

_c = _c + ['HMMWV_M1151_M2_DES_EP1'];
_i = _i + [['','',850,20,-2,1,1,0,'US',[]]];

_c = _c + ['HMMWV_M998_crows_M2_DES_EP1'];
_i = _i + [['','',1250,22,-2,1,1,0,'US',[]]];

_c = _c + ['HMMWV_M998_crows_MK19_DES_EP1'];
_i = _i + [['','',1375,22,-2,1,1,0,'US',[]]];

_c = _c + ['HMMWV_TOW_DES_EP1'];
_i = _i + [['','',2450,20,-2,2,1,0,'US',[]]];

_c = _c + ['HMMWV_Avenger_DES_EP1'];
_i = _i + [['','',1750,25,-2,3,1,0,'US',[]]];

_c = _c + ['HMMWV_Ambulance_DES_EP1'];
_i = _i + [['','',3950,22,-2,2,1,0,'US',[]]];

_c = _c + ['MTVR_DES_EP1'];
_i = _i + [['','',400,20,-2,0,1,0,'US',[]]];

_c = _c + ['MtvrSalvage_DES_EP1'];
_i = _i + [['','',450,21,-2,0,1,0,'US',[]]];

_c = _c + ['MtvrRepair_DES_EP1'];
_i = _i + [['','',1950,22,-2,1,1,0,'US',[]]];

_c = _c + ['MtvrReammo_DES_EP1'];
_i = _i + [['','',550,22,-2,1,1,0,'US',[]]];
...
_i = _i + [['','',1650,25,-2,2,2,0,'US',[]]];

_c = _c + ['M1126_ICV_mk19_EP1'];
_i = _i + [['','',1950,25,-2,2,2,0,'US',[]]];

_c = _c + ['M1129_MC_EP1'];
_i = _i + [['','',6900,25,-2,3,2,0,'US',[]]];

_c = _c + ['M1135_ATGMV_EP1'];
_i = _i + [['','',3850,25,-2,2,2,0,'US',[]]];

_c = _c + ['M1128_MGS_EP1'];
_i = _i + [['','',4450,25,-2,3,2,0,'US',[]]];

_c = _c + ['M1133_MEV_EP1'];
_i = _i + [['','',5550,25,-2,2,2,0,'US',[]]];

_c = _c + ['HMMWV_Terminal_EP1'];
_i = _i + [['','',1000,15,-2,2,1,0,'US',[]]];

_c = _c + ['AH6X_EP1'];
_i = _i + [['UAV AH-6X','',7750,15,-2,2,1,0,'US',[]]];

_c = _c + ['MQ9PredatorB'];
_i = _i + [['','',7750,15,-2,2,1,0,'US',[]]];

/* Heavy Vehicles */

_c = _c + ['M2A2_EP1'];
_i = _i + [['','',5450,30,-2,1,2,0,'US',[]]];

_c = _c + ['M2A3_EP1'];
_i = _i + [['','',5950,32,-2,2,2,0,'US',[]]];

_c = _c + ['M1A1_US_DES_EP1'];
_i = _i + [['','',8650,40,-2,2,2,0,'US',[]]];

_c = _c + ['MLRS_DES_EP1'];
_i = _i + [['','',7800,40,-2,3,2,0,'US',[]]];

_c = _c + ['M1A2_US_TUSK_MG_EP1'];
_i = _i + [['','',9950,40,-2,3,2,0,'US',[]]];

_c = _c + ['M6_EP1'];
_i = _i + [['','',8200,35,-2,3,2,0,'US',[]]];

/* Air Vehicles */
_c = _c + ['MH6J_EP1'];
_i = _i + [['','',5500,35,-2,0,3,0,'US',[]]];

_c = _c + ['UH60M_EP1'];
_i = _i + [['','',9000,35,-2,0,3,0,'US',[]]];

_c = _c + ['UH60M_MEV_EP1'];
_i = _i + [['','',6550,35,-2,0,3,0,'US',[]]];

_c = _c + ['CH_47F_EP1'];
_i = _i + [['','',10000,40,-2,0,3,0,'US',[]]];

_c = _c + ['C130J_US_EP1'];
_i = _i + [['','',15500,55,-2,2,3,0,'US',[]]];

//_c = _c + ['AH6X_EP1'];
//_i = _i + [['','',35000,50,-2,1,3,0,'US',[]]];

_c = _c + ['AH6J_EP1'];
_i = _i + [['','',13500,50,-2,1,3,0,'US',[]]];

_c = _c + ['AH64D_EP1'];
_i = _i + [['','',35950,60,-2,2,3,0,'US',[]]];

_c = _c + ['A10_US_EP1'];
_i = _i + [['','',44500,65,-2,3,3,0,'US',[]]];
...
_i = _i + [['','',800,0,1,0,'Defense',0,'US',[]]];

_c = _c + ['Stinger_Pod_US_EP1'];
_i = _i + [['','',850,0,1,0,'Defense',0,'US',[]]];

_c = _c + ['M252_US_EP1'];
_i = _i + [['','',1150,0,1,0,'Defense',0,'US',[]]];

_c = _c + ['M119_US_EP1'];
_i = _i + [['','',3800,0,1,0,'Defense',0,'US',[]]];

/* Defense Structures */
_c = _c + ['US_WarfareBBarrier5x_EP1'];
_i = _i + [['','',15,0,0,0,'Fortification',0,'US',[]]];

_c = _c + ['US_WarfareBBarrier10x_EP1'];
_i = _i + [['','',25,0,0,0,'Fortification',0,'US',[]]];
