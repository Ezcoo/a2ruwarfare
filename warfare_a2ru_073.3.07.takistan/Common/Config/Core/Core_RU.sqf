...
_c = _c + ['RU_Soldier_AT'];
_i = _i + [['','',600,5,-1,1,0,0.9,'Russians',[]]];

_c = _c + ['RU_Soldier_HAT'];
_i = _i + [['','',930,6,-1,3,0,0.92,'Russians',[]]];

_c = _c + ['RU_Soldier_AA'];
_i = _i + [['','',450,6,-1,1,0,0.91,'Russians',[]]];
...
_i = _i + [['','',300,5,-1,2,0,0.94,'Russians',[]]];
...
_c = _c + ['KamazRepair'];
_i = _i + [['','',1950,21,-2,1,1,0,'Russians',[]]];
...
_i = _i + [['','',3950,25,-2,2,1,0,'Russians',[]]];
...
_c = _c + ['GRAD_RU'];
_i = _i + [['','',7500,25,-2,3,1,0,'Russians',[]]];

/* Heavy Vehicles */
_c = _c + ['BMP3'];
_i = _i + [['','',5400,35,-2,if (WF_A2_Vanilla) then {0} else {2},2,0,'Russians',[]]];

_c = _c + ['T72_RU'];
_i = _i + [['','',6900,40,-2,if (WF_A2_Vanilla) then {1} else {2},2,0,'Russians',[]]];

_c = _c + ['T90'];
_i = _i + [['','',9250,40,-2,if (WF_A2_Vanilla) then {2} else {3},2,0,'Russians',[]]];
...
_i = _i + [['','',6550,35,-2,0,3,0,'Russians',[]]];

_c = _c + ['Mi17_rockets_RU'];
_i = _i + [['','',20500,45,-2,1,3,0,'Russians',[]]];

_c = _c + ['Mi24_V'];
_i = _i + [['','',27000,50,-2,2,3,0,'Russians',[]]];

_c = _c + ['Mi24_P'];
_i = _i + [['','',23800,52,-2,2,3,0,'Russians',[]]];

_c = _c + ['Su34'];
_i = _i + [['','',48000,55,-2,3,3,0,'Russians',[]]];

_c = _c + ['Su39'];
_i = _i + [['','',42500,55,-2,3,3,0,'Russians',[]]];

_c = _c + ['Ka52'];
_i = _i + [['','',35950,55,-2,2,3,0,'Russians',[]]];

_c = _c + ['Ka52Black'];
_i = _i + [['','',35950,55,-2,3,3,0,'Russians',[]]];

/* Special */
_c = _c + ['Pchela1T'];
_i = _i + [['','',9000,35,-2,2,3,0,'Russians',[]]];
...
_c = _c + ['D30_RU'];
_i = _i + [['','',3800,0,1,0,'Defense',0,'Russians',[]]];
