...
missionNamespace setVariable [Format["WFBE_C_UPGRADES_%1_COSTS", _side], [
	[[300,750],[700,2250],[1300,4500]], //--- Barracks
	[[800,1600],[1800,4500],[3500,8000]], //--- Light
	[[2500,5000],[5000,10000]], //--- Heavy
...
missionNamespace setVariable [Format["WFBE_C_UPGRADES_%1_LINKS", _side], [
	...
	[[],[WFBE_UP_HEAVY,2],[WFBE_UP_HEAVY,2]], //--- Air
	[
	...
	[
		...
		[[WFBE_UP_GEAR,3],[WFBE_UP_HEAVY,2]]
	], //--- Artillery Ammo
