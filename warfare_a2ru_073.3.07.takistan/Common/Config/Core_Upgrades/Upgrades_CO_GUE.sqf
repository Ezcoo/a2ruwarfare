...
missionNamespace setVariable [Format["WFBE_C_UPGRADES_%1_COSTS", _side], [
	[[300,750],[600,2250],[1200,5500]], //--- Barracks
	[[1600,3200],[3200,6400]], //--- Light
	[[15000,30000]], //--- Heavy
	[[10000,20000],[20000,40000]], //--- Air
	[[2000,8000],[3000,12000],[4000,24000]], //--- Paratroopers
	[[2500,5600]], //--- UAV
	[[1800,6200],[3600,12400],[7500,24800],[15000,49600]], //--- Supply
	[[500,2000],[1500,4000],[2500,7500]], //--- Respawn Range
	[[1000,4000]], //--- Airlift
	[[3500,10000]], //--- Custom Flares
	[[1200,3500],[1800,4400],[100500,500100]], //--- Artillery Time
	[[50000,250000]], //--- ICBM
	[[1500,5000]], //--- Fast Travel
	[[500,1500],[1000,3000],[2000,6000]], //--- Gear
	[[750,2250]], //--- Build Ammo
	[[4500,35000]], //--- EASA
...
missionNamespace setVariable [Format["WFBE_C_UPGRADES_%1_LINKS", _side], [
	...
	[[WFBE_UP_AIR, 2]] //--- Aircraft AA Missiles
]];
