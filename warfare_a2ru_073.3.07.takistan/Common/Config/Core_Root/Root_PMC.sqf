...
if (isServer) then {
	...
	missionNamespace setVariable [Format["REINFORCER_%1_GROUND_UNITS", _side], [
		[["Soldier_TL_PMC","Soldier_MG_PKM_PMC","Soldier_MG_PKM_PMC","Soldier_MG_PMC","Soldier_AT_PMC","Soldier_PMC","Soldier_Medic_PMC","Soldier_GL_M16A2_PMC"], 0, 2],
		[["Soldier_TL_PMC","Soldier_MG_PKM_PMC","Soldier_AT_PMC","Soldier_AT_PMC","Soldier_AT_PMC","Soldier_AT_PMC","Soldier_GL_PMC"], 10, 1],
		[["Soldier_TL_PMC","Soldier_Sniper_PMC","Soldier_Sniper_PMC","Soldier_Sniper_PMC","Soldier_Sniper_KSVK_PMC"], 10, 1],
		[["Soldier_Bodyguard_AA12_PMC","Soldier_Bodyguard_AA12_PMC","Soldier_Bodyguard_M4_PMC","Soldier_Bodyguard_M4_PMC","Soldier_Engineer_PMC","Soldier_M4A3_PMC","Soldier_M4A3_PMC","Soldier_Bodyguard_M4_PMC"], 10, 1],
		[["ArmoredSUV_PMC","ArmoredSUV_PMC"], 10, 2],
		[["BRDM2_TK_GUE_EP1","BRDM2_TK_GUE_EP1"], 10, 1],
		[["Ural_ZU23_TK_GUE_EP1","Ural_ZU23_TK_GUE_EP1"], 20, 1],
		[["Soldier_TL_PMC","BTR40_MG_TK_GUE_EP1","Soldier_MG_PMC","Soldier_MG_PKM_PMC","Soldier_AT_PMC","Soldier_AT_PMC"], 10, 2],
		[["Soldier_TL_PMC","BRDM2_TK_GUE_EP1","BRDM2_TK_GUE_EP1","Soldier_MG_PKM_PMC","Soldier_AT_PMC","Soldier_Medic_PMC","Soldier_PMC"], 10, 2],
	...
	missionNamespace setVariable [Format["REINFORCER_%1_GROUND_UNITS_CONVOY", _side], [
		[[
			[["ArmoredSUV_PMC"], "V3S_TK_GUE_EP1", ["ArmoredSUV_PMC"]],
			[
				["Soldier_TL_PMC","Soldier_MG_PKM_PMC","Soldier_MG_PKM_PMC","Soldier_MG_PMC","Soldier_AT_PMC","Soldier_PMC","Soldier_Medic_PMC","Soldier_GL_M16A2_PMC"],
				["Soldier_TL_PMC","Soldier_MG_PKM_PMC","Soldier_AT_PMC","Soldier_AT_PMC","Soldier_AT_PMC","Soldier_AT_PMC","Soldier_GL_PMC"]
			]
		], 0, 2],
		[[
			[["BRDM2_TK_GUE_EP1"], "V3S_TK_GUE_EP1", ["BRDM2_TK_GUE_EP1"]],
			[
				["Soldier_Bodyguard_AA12_PMC","Soldier_Bodyguard_AA12_PMC","Soldier_Bodyguard_M4_PMC","Soldier_Bodyguard_M4_PMC","Soldier_Engineer_PMC","Soldier_M4A3_PMC","Soldier_M4A3_PMC","Soldier_Medic_PMC"],
				["Soldier_TL_PMC","Soldier_AT_PMC","Soldier_AT_PMC","Soldier_AT_PMC","Soldier_Engineer_PMC","Soldier_M4A3_PMC","Soldier_Sniper_PMC","Soldier_Medic_PMC"],
				["Soldier_TL_PMC","Soldier_Sniper_PMC","Soldier_Sniper_PMC","Soldier_Sniper_PMC","Soldier_Sniper_KSVK_PMC"]
			]
		], 10, 1],
		[[
			...
			[
				["Soldier_TL_PMC","Soldier_AT_PMC","Soldier_AT_PMC","Soldier_AT_PMC","Soldier_Engineer_PMC","Soldier_M4A3_PMC","Soldier_Sniper_PMC","Soldier_Medic_PMC"],
				["Soldier_TL_PMC","Soldier_Sniper_PMC","Soldier_Engineer_PMC","Soldier_MG_PKM_PMC","Soldier_MG_PKM_PMC","Soldier_AA_PMC","Soldier_AA_PMC","Soldier_AA_PMC"],
				["Soldier_TL_PMC","Soldier_Sniper_PMC","Soldier_Sniper_PMC","Soldier_Sniper_PMC","Soldier_Sniper_KSVK_PMC"]
			]
		], 10, 2],
		[[
	...
	if (WF_A2_CombinedOps) then {
		...
		missionNamespace setVariable [Format["REINFORCER_%1_NAVAL_UNITS", _side], [
			[[["Fishing_Boat","Smallboat_1"],["Soldier_TL_PMC","Soldier_MG_PKM_PMC","Soldier_MG_PKM_PMC","Soldier_MG_PMC","Soldier_AT_PMC","Soldier_PMC","Soldier_Medic_PMC","Soldier_GL_M16A2_PMC"]], 0, 2],
			[["Fishing_Boat",["Soldier_Bodyguard_AA12_PMC","Soldier_Bodyguard_AA12_PMC","Soldier_Bodyguard_M4_PMC","Soldier_Bodyguard_M4_PMC","Soldier_Engineer_PMC","Soldier_M4A3_PMC","Soldier_M4A3_PMC","Soldier_Bodyguard_M4_PMC"]], 0, 1],
			[[["Fishing_Boat","Smallboat_2"],["Soldier_TL_PMC","Soldier_AT_PMC","Soldier_AT_PMC","Soldier_AT_PMC","Soldier_Engineer_PMC","Soldier_M4A3_PMC","Soldier_Sniper_PMC","Soldier_Medic_PMC"]], 0, 1]
		]];
	};
	...
	missionNamespace setVariable [Format["REINFORCER_%1_AIR_UNITS", _side], [
		[[if (WF_A2_CombinedOps) then {["Ka60_PMC","Mi17_Civilian"]} else {"Ka60_PMC"},["Soldier_TL_PMC","Soldier_MG_PKM_PMC","Soldier_MG_PKM_PMC","Soldier_MG_PMC","Soldier_AT_PMC","Soldier_PMC","Soldier_Medic_PMC","Soldier_GL_M16A2_PMC"]], 0, 2],
		[[if (WF_A2_CombinedOps) then {["Ka60_PMC","Mi17_Civilian"]} else {"Ka60_PMC"},["Soldier_Bodyguard_AA12_PMC","Soldier_Bodyguard_AA12_PMC","Soldier_Bodyguard_M4_PMC","Soldier_Bodyguard_M4_PMC","Soldier_Engineer_PMC","Soldier_M4A3_PMC","Soldier_M4A3_PMC","Soldier_Bodyguard_M4_PMC"]], 10, 1],
		[[if (WF_A2_CombinedOps) then {["Ka60_PMC","Mi17_Civilian"]} else {"Ka60_PMC"},["Soldier_TL_PMC","Soldier_Sniper_PMC","Soldier_Sniper_PMC","Soldier_AT_PMC","Soldier_Sniper_PMC","Soldier_Sniper_KSVK_PMC","Soldier_Medic_PMC"]], 10, 1],
		[[if (WF_A2_CombinedOps) then {["Ka60_PMC","Mi17_Civilian"]} else {"Ka60_PMC"},["Soldier_TL_PMC","Soldier_Sniper_PMC","Soldier_Engineer_PMC","Soldier_MG_PKM_PMC","Soldier_MG_PKM_PMC","Soldier_AA_PMC","Soldier_AA_PMC","Soldier_AA_PMC"]], 10, 1]
	]];
};
