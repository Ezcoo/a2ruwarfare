...
missionNamespace setVariable [Format["WFBE_%1STARTINGVEHICLES", _side], ['HMMWV_Ambulance','LAV25','HMMWV_MK19','HMMWV_MK19','BAF_Jackal2_L2A1_W','BAF_Jackal2_L2A1_W']];//--- Starting Vehicles.
...
if (isServer) then {
	...
	missionNamespace setVariable [Format["REINFORCER_%1_GROUND_UNITS", _side], [
		[["USMC_Soldier_SL","USMC_Soldier_TL","USMC_Soldier_AR","USMC_Soldier_AR","USMC_Soldier_MG","USMC_Soldier_LAT","USMC_Soldier","USMC_Soldier_Medic"], 0, 2],
		...
		[["HMMWV_Avenger","M6_EP1"], 50, 1],
		[["USMC_Soldier_TL","LAV25","USMC_Soldier_MG","USMC_Soldier_AR","USMC_Soldier_AT","USMC_Soldier_LAT"], 40, 2],
		[["LAV25","LAV25"], 40, 1],
		[["USMC_Soldier_SL","AAV","USMC_Soldier_AR","USMC_Soldier_LAT","USMC_Soldier_Medic","M6_EP1"], 50, 2],
		[["M1A1","M1A1"], 50, 1],
		[["M1A2_TUSK_MG","M1A2_TUSK_MG"], 80, 2],
		[["M1A2_TUSK_MG","M1A2_TUSK_MG","M6_EP1"], 100, 3]
	]];
	...
	missionNamespace setVariable [Format["REINFORCER_%1_GROUND_UNITS_CONVOY", _side], [
		[[
			...
			[
				["USMC_Soldier_SL","USMC_Soldier_TL","USMC_Soldier_AR","USMC_Soldier_AR","USMC_Soldier_MG","USMC_Soldier_LAT","USMC_Soldier","USMC_Soldier_Medic"],
				["USMC_Soldier_SL","USMC_Soldier_LAT","USMC_Soldier_LAT","USMC_SoldierS_Sniper","USMC_Soldier_LAT","USMC_Soldier","USMC_Soldier_Medic","USMC_Soldier_Medic","USMC_Soldier_GL"]
			]
		], 0, 2],
		[[
		...
		[[
			...
			[
				...
				["USMC_Soldier_TL","USMC_Soldier_AR","USMC_Soldier_HAT","USMC_Soldier_HAT","USMC_Soldier_AT","USMC_Soldier_AT"]
			]
		], 60, 2],
		[[
	...
	missionNamespace setVariable [Format["REINFORCER_%1_AIR_UNITS", _side], [
		[[["CH_47F_EP1","UH60M_EP1"],["USMC_Soldier_SL","USMC_Soldier_TL","USMC_Soldier_AR","USMC_Soldier_AR","USMC_Soldier_MG","USMC_Soldier_LAT","USMC_Soldier","USMC_Soldier_Medic"]], 0, 2],
		[["MH6J_EP1",["FR_TL","FR_AR","FR_GL","FR_Marksman","FR_R","FR_Corpsman","FR_R","FR_Corpsman","FR_AC","FR_AC"]], 50, 1],
		[["CH_47F_EP1",["USMC_Soldier_TL","USMC_Soldier_AR","USMC_Soldier_AT","USMC_Soldier_AT","USMC_Soldier_AT","USMC_Soldier_AT","USMC_Soldier_AR","USMC_Soldier_MG","USMC_Soldier_LAT","USMC_Soldier","USMC_Soldier_Medic","USMC_Soldier_GL"]], 60, 1],
		[["CH_47F_EP1",["USMC_Soldier_TL","USMC_Soldier_AR","USMC_Soldier_AT","USMC_Soldier_AT","USMC_Soldier_AT","USMC_Soldier_AT","USMC_Soldier_AR","USMC_Soldier_MG","USMC_Soldier_LAT","USMC_Soldier","USMC_Soldier_Medic","USMC_Soldier_HAT","USMC_Soldier_AT","USMC_Soldier_AT","USMC_Soldier_GL"]], 80, 1]
	]];
};
