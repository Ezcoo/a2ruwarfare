...
["INFORMATION", Format ["Server_ProcessUpgrade.sqf: [%1] Upgrade ID [%2] is now at level [%3]. Ordered by player? [%4]", _side, _upgrade_id, _upgrade_level + 1, _upgrade_isplayer]] Call WFBE_CO_FNC_LogContent;