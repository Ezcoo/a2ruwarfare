...
switch (_town getVariable "wfbe_town_type") do { // _units = [[group type, force (chance multiplier), group kind (0 inf, 1 veh)]]
	case "TinyTown1": {
		_units = [["Squad", 2, 0], ["Team", 2, 0],["Team_AT", 1, 0],["Team_MG", 1, 0]];
		_percentage_inf = 100;
		_groups_max = 2;
	};
	case "SmallTown1": {
		_units = [["Squad", 1, 0], ["Team", 1, 0],["Team_AT", 1, 0],["Motorized", 2, 1]];
		_percentage_inf = 85;
		_groups_max = 2;
	};
	case "SmallTown2": {
		_units = [["Team", 2, 0],["Team_MG", 1, 0],["Team_AT", 2, 0],["Motorized", 2, 1]];
		_percentage_inf = 85;
		_groups_max = 2;
	};
	case "MediumTown1": {
		_units = [["Squad", 1, 0],["Team", 2, 0],["Team_MG", 1, 0],["Team_AA", 1, 0],["Team_AT", 2, 0],["Team_Sniper", 2, 0],["Motorized", 1, 1],["Mechanized", 2, 1],["Mechanized_Heavy", 1, 1]];
		_percentage_inf = 78;
		_groups_max = 2;
	};
	case "MediumTown2": {
		_units = [["Team", 2, 0],["Team_Sniper", 1, 0],["Team_MG", 1, 0],["Team_AT", 2, 0],["Motorized", 1, 1],["Mechanized", 1, 1],["AA_Light", 1, 1],["Mechanized_Heavy", 2, 1]];
		_percentage_inf = 75;
		_groups_max = 4;
	};
	case "LargeTown1": {
		_units = [["Squad", 2, 0],["Team", 1, 0],["Team_Sniper", 1, 0],["Team_AA", 1, 0],["Team_MG", 1, 0],["Team_AT", 3, 0],["Team_HAT", 1, 0],["Mechanized", 1, 1],["AA_Light", 1, 1],["Mechanized_Heavy", 4, 1],["Armored_Light", 2, 1]];
		_percentage_inf = 70;
		_groups_max = 4;
	};
	case "LargeTown2": {
		_units = [["Squad", 2, 0],["Team_Sniper", 1, 0],["Team_MG", 1, 0],["Team_AA", 1, 0],["Team_AT", 3, 0],["Team_HAT", 1, 0],["AA_Light", 1, 1],["Mechanized_Heavy", 2, 1],["Armored_Light", 2, 1],["Armored_Heavy", 1, 1]];
		_percentage_inf = 65;
		_groups_max = 4;
	};
	case "HugeTown1": {
		_units = [["Squad", 2, 0],["Squad_Advanced", 1, 0],["Team_Sniper", 1, 0],["Team_MG", 2, 0],["Team_AA", 1, 0],["Team_AT", 3, 0],["Team_HAT", 2, 0],["AA_Light", 1, 1],["Mechanized_Heavy", 1, 1],["Armored_Light", 3, 1],["Armored_Heavy", 2, 1]];
		_percentage_inf = 60;
		_groups_max = 6;
	};
	case "HugeTown2": {
		_units = [["Squad", 3, 0],["Squad_Advanced", 1, 0],["Team_Sniper", 2, 0],["Team_MG", 1, 0],["Team_AA", 2, 0],["Team_AT", 3, 0],["Team_HAT", 2, 0],["AA_Light", 1, 1],["Mechanized_Heavy", 2, 1],["Armored_Light", 1, 1],["Armored_Heavy", 3, 1]];
		_percentage_inf = 60;
		_groups_max = 6;
	};
...
switch (true) do {
	case (_sv < 10): {
		_units = [["Team", 1, 0],["Team_AT", 1, 0]];
		_percentage_inf = 100;
		_groups_max = 2;
	};
	case (_sv >= 10 && _sv < 20): {
		_units = [["Team", 2, 0],["Team_MG", 1, 0],["Team_AT", 1, 0],["Motorized", 2, 1],["Mechanized", 2, 1]];
		_percentage_inf = 85;
		_groups_max = 2;
	};
	case (_sv >= 20 && _sv < 40): {
		_units = [["Squad", 2, 0],["Team_MG", 1, 0],["Team", 2, 0],["Team_AT", 2, 0],["Team_AA", 1, 0],["Team_Sniper", 1, 0],["Motorized", 2, 1],["Mechanized", 2, 1],["Mechanized_Heavy", 1, 1],["Armored_Light", 2, 1]];
		_percentage_inf = 80;
		_groups_max = 2;
	};
	case (_sv >= 40 && _sv < 60): {
		_units = [["Squad", 2, 0],["Team_MG", 1, 0],["Team", 2, 0],["Team_AT", 2, 0],["Team_AA", 1, 0],["Team_HAT", 1, 0],["Squad_Advanced", 1, 0],["Team_Sniper", 2, 0],["Motorized", 2, 1],["Mechanized", 2, 1],["AA_Light", 1, 1],["Mechanized_Heavy", 1, 1],["Armored_Light", 2, 1],["Armored_Light", 2, 1]];
		_percentage_inf = 75;
		_groups_max = 4;
	};
	case (_sv >= 60 && _sv < 80): {
		_units = [["Squad", 2, 0],["Team_MG", 1, 0],["Team", 2, 0],["Team_AT", 2, 0],["Team_AA", 2, 0],["Team_HAT", 2, 0],["Squad_Advanced", 1, 0],["Team_Sniper", 2, 0],["Motorized", 1, 1],["Mechanized", 2, 1],["Mechanized_Heavy", 1, 1],["AA_Light", 2, 1],["Armored_Light", 1, 1],["Armored_Light", 2, 1],["Armored_Heavy", 2, 1]];
		_percentage_inf = 70;
		_groups_max = 4;
	};
	case (_sv >= 80 && _sv < 100): {
		_units = [["Squad", 2, 0],["Team_MG", 1, 0],["Team", 1, 0],["Team_AT", 2, 0],["Team_AA", 2, 0],["Team_HAT", 2, 0],["Squad_Advanced", 2, 0],["Team_Sniper", 2, 0],["Motorized", 1, 1],["Mechanized", 1, 1],["Mechanized_Heavy", 2, 1],["AA_Light", 2, 1],["Armored_Light", 2, 1],["Armored_Light", 2, 1],["Armored_Heavy", 2, 1]];
		_percentage_inf = 65;
		_groups_max = 6;
	};
