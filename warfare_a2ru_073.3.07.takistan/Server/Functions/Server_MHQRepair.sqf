...
// Prodavec: restore MHQ EHs for clients
// -----------------------------------------------------------------------
_MHQ addEventHandler ["Killed", {_this spawn WFBE_SE_FNC_OnHQKilled}];
//_MHQ addEventHandler ["HandleDamage", {_this call WFBE_SE_FNC_OnHQKilled}];
[nil, "RestoreMHQEventHandlers", [_MHQ, _side]] call WFBE_CO_FNC_SendToClients;
// -----------------------------------------------------------------------
