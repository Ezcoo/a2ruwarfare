...
//["INFORMATION", Format ["1980| _type: %1 | _side: %2 | _index: %3  | _position %4 | _direction %5",_type, str _side, _index, str _position , str _direction]] Call WFBE_CO_FNC_LogContent;


_logik = (_side) Call WFBE_CO_FNC_GetSideLogic;

hint format["%1",_logik];
...
["INFORMATION", Format ["Const1980 %1  %2",_structures, _rlType ]] Call WFBE_CO_FNC_LogContent;	

_startTime = time;
_timeNextUpdate = _startTime + _time;

["INFORMATION", Format ["Const1980 %1  %2",_startTime, _timeNextUpdate ]] Call WFBE_CO_FNC_LogContent;	
...
// Prodavec: Reinforced Building
// -----------------------------------------------------------------------
if ((missionNamespace getVariable "WFBE_C_GAMEPLAY_REINFORCEDBUILDINGS") > 0) then
{
...
if (!isNull _site) then {
	["INFORMATION", Format ["Construction_SmallSite.sqf before _logik: [%1]", _logik getVariable "wfbe_structures"]] Call WFBE_CO_FNC_LogContent;	
	_logik setVariable ["wfbe_structures", (_logik getVariable "wfbe_structures") + [_site], true];
	
	["INFORMATION", Format ["Construction_SmallSite.sqf after _logik: [%1]", str _site]] Call WFBE_CO_FNC_LogContent;	
	...
	["INFORMATION", Format ["Construction_SmallSite.sqf: [%1]", _logik getVariable "wfbe_structures"]] Call WFBE_CO_FNC_LogContent;	
