...
if (isHostedServer || (!isHeadLessClient && !isDedicated)) then {
	...
	12452 cutRsc  ["b2zgroup","BLACK FADED",5];
};

setViewDistance 4000; //--- Server & Client default View Distance.
...
// Prodavec: call/spawn compile instead of execVM
// ----------------------------------------------
call compile preprocessFileLineNumbers "Common\Init\Init_Common.sqf"; //--- Execute the common files.
objNull spawn compile preprocessFileLineNumbers "Common\Init\Init_Towns.sqf"; //--- Execute the towns file.
// ----------------------------------------------
